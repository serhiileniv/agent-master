// Agent Master promo choreographer.
//
...
// Agent Master derives a card's working/idle/done state purely from terminal output, so
...
const CAPTURE_TITLE = 'AgentMasterPromoCapture'
