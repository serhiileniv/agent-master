...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo): void {
    console.error('[agentmaster] renderer crashed:', error, info.componentStack)
  }
      ...
      <div className="crash">
        <div className="crash__card">
          ...
          <p className="crash__msg">
            Agent Master hit an unexpected error. Your open terminals were interrupted, but your
