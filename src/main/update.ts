...
// Installers are published as GitHub Releases on this repo (Serhii-Leniv/spymaster,
...
const RELEASES_API = 'https://api.github.com/repos/Serhii-Leniv/spymaster/releases/latest'
...
const DOWNLOAD_URL = 'https://serhii-leniv.github.io/spymaster'
