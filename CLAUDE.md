...
Agent Master is an Electron desktop app that runs multiple CLI coding agents side by side, each in its own
...
- To let the user see a change in the real app, use the `run-agentmaster` skill.
